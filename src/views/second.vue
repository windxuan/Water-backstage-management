...
<script>
// 导入子组件
import methodDialog from './dialogList/methodDialog.vue';
...
export default {
  ...
  components: {
    methodDialog, // Dialog弹框内容 -- 提取为子组件 -- 方法
  },
  methods: {
